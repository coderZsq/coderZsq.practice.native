...
#ifndef SQClassInfo_h
#define SQClassInfo_h
...
/* OC对象 */
struct sq_objc_object {
    void *isa;
};

/* 类对象 */
struct sq_objc_class : sq_objc_object {
    Class superclass;
    cache_t cache;
...
public:
    ...
    sq_objc_class* metaClass() {
        return (sq_objc_class *)((long long)isa & ISA_MASK);
    }
};
