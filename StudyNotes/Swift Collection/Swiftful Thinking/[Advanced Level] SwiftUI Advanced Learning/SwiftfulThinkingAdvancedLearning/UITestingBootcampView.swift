...
class UITestingBootcampViewModel: ObservableObject {
    ...
    let placeholderTest: String = "Add name here..."
    @Published var testFieldText: String = ""
    ...
    func signUpButtonPressed() {
        guard !testFieldText.isEmpty else { return }
...
extension UITestingBootcampView {
    ...
    private var signUpLayer: some View {
        VStack {
            TextField(vm.placeholderTest, text: $vm.testFieldText )
                .font(.headline)
                .padding()
