...
extension CloudKitUtility {
    ...
    static func fetch<T: CloudKitableProtocol>(
        ...
        Future { promise in
            CloudKitUtility.fetch(predicate: predicate, recordType: recordType, sortDescription: sortDescription, resultLimit: resultLimit) { (items: [T]) in
    ...
    static private func fetch<T: CloudKitableProtocol>(
        ...
        completion: @escaping (_ items: [T]) -> ()) {
            ...
            // Create operation
            let operation = createOperation(predicate: predicate, recordType: recordType, sortDescription: sortDescription, resultLimit: resultLimit)
