...
//        qDebug() << frame->data[0] << frame->data[1] << frame->data[2];
        ...
        /*
         * frame->data[0] 0x7fcb26826000 0x26000
         * frame->data[1] 0x7fcb26872000 0x72000
         * frame->data[2] 0x7fcb26885000 0x85000
         *
         * frame->data[1] - frame->data[0] = 311296 = y平面的大小
         * frame->data[2] - frame->data[1] = 77824 = u平面的大小
         *
...
//    av_image_alloc(frame->data, frame->linesize, 640, 480, AV_PIX_FMT_YUV420P, 1);
